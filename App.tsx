...
import { Mic, MicOff, Send, Camera, Settings, Sparkles, Activity, Power, Wifi, Key } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // speak(welcomeMsg.content); // Optional: don't speak on load to be less intrusive
